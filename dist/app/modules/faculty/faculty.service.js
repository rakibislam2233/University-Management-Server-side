...
const getSingleFacultyFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield faculty_model_1.Faculty.findOne({ id }).populate("academicDepartment");
    return result;
});
const updateFacultyIntoDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield faculty_model_1.Faculty.findOneAndUpdate({ id: id }, modifiedUpdatedData, {
        new: true,
        runValidators: true,
    });
    return result;
...
const deleteFacultyFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const deletedFaculty = yield faculty_model_1.Faculty.findOneAndUpdate({ id: id }, { isDeleted: true }, { new: true, session });
        if (!deletedFaculty) {
