...
const offredCourse_utils_1 = require("./offredCourse.utils");
const createOfferedCourseIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isSemesterRegistrationExits = yield semisterRegistation_model_1.SemisterRegistation.findById(semesterRegistration);
    ...
    const isAcademicDepartmentExits = yield academicDepertment_model_1.AcademicDepertment.findById(academicDepartment);
    ...
    const isDepartmentBelongToFaculty = yield academicDepertment_model_1.AcademicDepertment.findOne({
    ...
    const isSameOfferedCourseExistsWithSameRegisteredSemesterWithSameSection = yield offredCourse_model_1.OfferedCourse.findOne({
    ...
    const assignedSchedules = yield offredCourse_model_1.OfferedCourse.find({
        semesterRegistration,
        faculty,
        days: { $in: days },
    ...
    if ((0, offredCourse_utils_1.hasTimeConflict)(assignedSchedules, newSchedule)) {
    ...
    const result = yield offredCourse_model_1.OfferedCourse.create(Object.assign(Object.assign({}, payload), { academicSemester }));
    return result;
});
const getAllOfferedCoursesFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const offeredCourseQuery = new QueryBuilder_1.default(offredCourse_model_1.OfferedCourse.find(), query)
        .filter()
        .sort()
        .paginate()
        .fields();
...
const getSingleOfferedCourseFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const offeredCourse = yield offredCourse_model_1.OfferedCourse.findById(id);
    if (!offeredCourse) {
...
const updateOfferedCourseIntoDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isOfferedCourseExists = yield offredCourse_model_1.OfferedCourse.findById(id);
    ...
    const semesterRegistrationStatus = yield semisterRegistation_model_1.SemisterRegistation.findById(semesterRegistration);
    ...
    const result = yield offredCourse_model_1.OfferedCourse.findByIdAndUpdate(id, payload, {
        new: true,
    });
    return result;
});
const deleteOfferedCourseFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const semesterRegistrationStatus = yield semisterRegistation_model_1.SemisterRegistation.findById(semesterRegistation).select("status");
    if ((semesterRegistrationStatus === null || semesterRegistrationStatus === void 0 ? void 0 : semesterRegistrationStatus.status) !== "UPCOMING") {
    ...
    const result = yield offredCourse_model_1.OfferedCourse.findByIdAndDelete(id);
    return result;
});
