...
router.post("/create-admin", (0, authenticateToken_1.default)(user_constant_1.USER_ROLE.admin), (0, validateRequest_1.default)(admin_validation_1.createAdminValidationSchema), user_controller_1.userController.createAdmin);
