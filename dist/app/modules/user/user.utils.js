...
exports.generateAdminId = exports.findLastAdminId = exports.generateFacultyId = exports.findLastFacultyId = exports.genaretedId = exports.findLastStudentId = void 0;
...
const genaretedId = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    let currentId = (0).toString(); //by default 0000
    const lastStudentId = yield (0, exports.findLastStudentId)();
    const lastStudentSemisterYear = lastStudentId === null || lastStudentId === void 0 ? void 0 : lastStudentId.substring(0, 4);
    const lastStudentSemisterCode = lastStudentId === null || lastStudentId === void 0 ? void 0 : lastStudentId.substring(4, 6);
    const currentStudentSemisterYear = payload.year;
    const currentStudentSemisterCode = payload.code;
    if (lastStudentSemisterYear === currentStudentSemisterYear &&
...
exports.genaretedId = genaretedId;
// Faculty ID
