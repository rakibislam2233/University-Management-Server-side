...
exports.courseSevice = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const QueryBuilder_1 = __importDefault(require("../../builder/QueryBuilder"));
const course_constaint_1 = require("./course.constaint");
...
const getAllCourseFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const courseQuery = new QueryBuilder_1.default(course_model_1.Course.find().populate("preRequisiteCourses.course"), query)
        .search(course_constaint_1.courseSearchableFields)
        .filter()
        .sort()
        .paginate()
        .fields();
...
const updateCourseIntoDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const basicCourseUpdate = yield course_model_1.Course.findByIdAndUpdate(id, courseRemainingData, {
            new: true,
            runValidators: true,
            session,
        });
        ...
        if (preRequisiteCourses && preRequisiteCourses.length > 0) {
            const deletedPrerequisites = preRequisiteCourses
                ...
                .map((el) => el.course);
            const deletedPrerequisitesCourse = yield course_model_1.Course.findByIdAndUpdate(id, {
                $pull: {
                    preRequisiteCourses: {
            ...
            const addPreRequisite = preRequisiteCourses.filter((el) => el.course && !el.isDeleted);
            const addPreRequisiteCourse = yield course_model_1.Course.findByIdAndUpdate(id, {
                $addToSet: {
...
const removeFacultiesIntoDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield course_model_1.CourseFaculty.findByIdAndUpdate(id, {
