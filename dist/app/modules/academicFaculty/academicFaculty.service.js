...
exports.academicFacultySevice = void 0;
...
const updateAcademicFacultyIntoDB = (id, paylod) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_model_1.AcademicFaculty.findByIdAndUpdate({ _id: id }, paylod, {
        new: true,
    });
    return result;
});
exports.academicFacultySevice = {
